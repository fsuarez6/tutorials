...
% T9.1
\begin{question}
  For each transistor shown in \fref{fig:t09-1}, determine the operating region. Assume $V_{\gamma}=\SI{0.6}{\volt}$.
  \begin{figure}[!h]
    \centering
    \subfloat[]{\includegraphics[scale=1]{t09-1a}} \qquad\qquad
    \subfloat[]{\includegraphics[scale=1]{t09-1b}} \qquad\qquad
    \subfloat[]{\includegraphics[scale=1]{t09-1c}}
    \caption{}
    \label{fig:t09-1}
  \end{figure}
\end{question}
...
\newpage
\begin{question}
  The transistor 2N3904, which has given I-V curve shown in \fref{fig:t09-2a}, is now connected in the circuit shown in \fref{fig:t09-2b}. Derive the load line equation and graphically determine the Q-point of the transistor.
  \begin{figure}[!h]
    \centering
    \subfloat[]{\includegraphics[height=50mm]{bjt-i-v-curve}\label{fig:t09-2a}} \qquad\qquad
    \subfloat[]{\includegraphics[height=50mm]{t09-2b}\label{fig:t09-2b}}
    \caption{}
  \end{figure}
\end{question}
\begin{solution}
...
\begin{question}
  \begin{wrapfigure}{r}{6.5cm}
    \centering
    \includegraphics[scale=0.8]{t09-3}
    \caption{}
    \label{fig:t09-3}
  \end{wrapfigure}
  Given the circuit of \fref{fig:t09-3}, determine the operation point of the transistor. Assume a $\SI{0.6}{\volt}$ offset voltage and $\beta = 150$. In what region is the transistor?
\end{question}
\begin{solution}
  Solution goes here
\end{solution}
